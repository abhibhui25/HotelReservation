...
public class HotelReservationTest {
    HotelReservation hotelReservationMain;

    @Before
    public void setup() {
        hotelReservationMain = new HotelReservation();
    }
    ...
    public void givenHotelList_ShouldReturnCheapestHotelInGivenDateRange() {
        hotelReservationMain.hotelList.add(new Hotel("Lakewood", 10000, "2020-01-25", "2020-01-26"));
        hotelReservationMain.hotelList.add(new Hotel("Bridgewood", 6000, "2020-02-12", "2020-02-14"));
        hotelReservationMain.hotelList.add(new Hotel("Ridgewood", 9000, "2020-11-01", "2020-11-04"));
        Hotel cheapestHotel = hotelReservationMain.findCheapestHotelByWeekdayRates("2020-01-01", "2020-12-31");
        Assert.assertEquals("Bridgewood", cheapestHotel.hotelName);
    }

    @Test
    public void givenWeekendWeekdayRates_WhenHotelCreated_ShouldNotBeNull() {
        Hotel hotel1 = new Hotel("Lakewood", 10000, 15000, "2020-01-25", "2020-01-26");
        Hotel hotel2 = new Hotel("Bridgewood", 6000, 10000, "2020-02-12", "2020-02-14");
        Hotel hotel3 = new Hotel("Ridgewood", 9000, 9500, "2020-11-01", "2020-11-04");
    ...
    public void givenHotelList_WhenCheapestByWeekendAndWeekdayRatesFound_ShouldReturntrue() {
        hotelReservationMain.hotelList.add(new Hotel("Lakewood", 10000, 15000, "2020-01-25", "2020-01-26"));
        hotelReservationMain.hotelList.add(new Hotel("Bridgewood", 6000, 10000, "2020-02-12", "2020-02-14"));
        hotelReservationMain.hotelList.add(new Hotel("Ridgewood", 9000, 9500, "2020-11-01", "2020-11-04"));
        ...
        Assert.assertEquals("Bridgewood", cheapestHotelByWeekdayRates.hotelName);
        Assert.assertEquals("Ridgewood", cheapestHotelByWeekendRates.hotelName);
    }

    @Test
    public void givenDetailsIncludingRatings_WhenHotelObjectCreated_ShouldNotBeNull() {
        Hotel hotel = new Hotel("Lakewood", 10000, 15000, "2020-01-25", "2020-01-26", 4);
        Assert.assertNotNull(hotel);
    }

    @Test
    public void givenHotelList_WhenCheapestBestRatedHotelInGivenDateRangeFound_ShouldBeTrue() {
        hotelReservationMain.hotelList.add(new Hotel("Lakewood", 10000, 15000, "2020-01-25", "2020-01-26", 4));
        hotelReservationMain.hotelList.add(new Hotel("Bridgewood", 6000, 10000, "2020-02-12", "2020-02-14", 3));
        hotelReservationMain.hotelList.add(new Hotel("Ridgewood", 6000, 9500, "2020-11-01", "2020-11-04", 4));
    ...
    public void givenHotelList_WhenCheapestBestRatedHotelInGivenDateRangeForRewardCustomerFound_ShouldBeTrue() {
        hotelReservationMain.hotelList.add(new Hotel("Lakewood", 10000, 15000, "2020-01-25", "2020-01-26", 4, 9000, 14000, "Reward"));
        hotelReservationMain.hotelList.add(new Hotel("Bridgewood", 6000, 10000, "2020-02-12", "2020-02-14", 3, 5000, 9000, "Reward"));
        hotelReservationMain.hotelList.add(new Hotel("Ridgewood", 6000, 9500, "2020-11-01", "2020-11-04", 4, 5000, 9000, "Reward"));
